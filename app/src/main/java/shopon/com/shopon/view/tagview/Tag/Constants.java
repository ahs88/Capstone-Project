package shopon.com.shopon.view.tagview.Tag;
...
public class Constants {
	...
	//----------------- separator TagView-----------------//
	public static final float DEFAULT_LINE_MARGIN = 3;
	public static final float DEFAULT_TAG_MARGIN = 1;
	public static final float DEFAULT_TAG_TEXT_PADDING_LEFT = 1;
	public static final float DEFAULT_TAG_TEXT_PADDING_TOP = 1;
	public static final float DEFAULT_TAG_TEXT_PADDING_RIGHT = 3;
